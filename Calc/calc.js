function values_pol(){
n=document.getElementById('selection').options[document.getElementById('selection').selectedIndex].value;
var element=''
  if (n!=''){
   element=element+'<br>'
	for (var i=0;i<n;i++){
	 element=element+'<input type="text" id="i_'+i.toString()+'" size="1px">X^'+(n-i).toString()+'+<input type="text" style="visibility:hidden" size="1px">'
	}
  }
  
  element=element+'<input type="text" id="i_'+n.toString()+'" size="1px">Const=0'
  element=element+'<br><br><textarea name="comment" cols="60" rows="20" id="comment"></textarea><br><br><input type="button" onclick="calc_pol()" value="Вычислить">'
  document.getElementById('place2').innerHTML=element
  document.getElementById('selection').selectedIndex=n
...
function calc_pol(){
 ...
 for (var i=0;i<n;i++){
  if (i!=0){
   var val=document.getElementById('i_'+i.toString()).value;
   if (parseFloat(val)<0){
     func=func+val+'*x^'+(n-i).toString()
   } else {
     func=func+'+'+val+'*x^'+(n-i).toString()
   }
  }
  ...
  if (i==0){
     func=document.getElementById('i_0').value+'*x^'+n.toString()
  }
 }
 
 var val=document.getElementById('i_'+n.toString()).value;
 if (parseFloat(val)<0){
   func=func+document.getElementById('i_'+n.toString()).value;
 } else {
   func=func+'+'+document.getElementById('i_'+n.toString()).value;
 }
...
function taylor(){
  func_taylor=document.getElementById('func').value;
  n_taylor=document.getElementById('n').value;
  a_taylor=document.getElementById('dot_a').value; 
  my_function(3,func_taylor)
}
...
function my_function(param,funct){
if (param!=0){
...
if (param==1){
	try {
	var root=Algebrite.eval('roots('+funct+')').toString()
	document.getElementById('comment').innerHTML+='Корни многочлена '+root+'\n'

	var root=Algebrite.eval('nroots('+funct+')').toString()
	document.getElementById('comment').innerHTML+='Численное значение корней '+root+'\n'
	}
...
if (param==2){
	var res_und=Algebrite.eval('integral('+funct+')').toString()
	 document.getElementById('comment').innerHTML+='Неопределенный интеграл равен '+res_und.toString()+'\n'
	 if (document.getElementById('upper').value=='pi'){
			var u=3.14; 
		} else {
		var u=parseInt(document.getElementById('upper').value);
	    }
    	
	if (document.getElementById('lower').value=='pi'){
			var l=3.14; 
		} else {
		var l=parseInt(document.getElementById('lower').value);
    }	
		if (!isNaN(u) && !isNaN(l)){
		  var defint=Algebrite.eval('defint('+funct+',x,'+u+','+l+')').toString()
		  document.getElementById('comment').innerHTML+='Значение определенного интеграла равно '+defint+'\n'
		}
	} 
	
	
if (param==3){
	var taylor=Algebrite.eval('taylor('+func_taylor+',x,'+parseInt(n_taylor)+','+parseInt(a_taylor)+')').toString()
	document.getElementById('comment').innerHTML+='Ряд Тейлора '+taylor+'\n'
}
